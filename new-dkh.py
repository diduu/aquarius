...
def small_spin(STEP, DIR, direction, rotations): # Rotations doesn't need to be an int
    # Set up pins as an output
    pi.set_mode(DIR, pigpio.OUTPUT)
    pi.set_mode(STEP, pigpio.OUTPUT)
...
if __name__ == "__main__":
    ...
    # One after the other
    #spin(26, 20, 0, 50) #reagent
    #sleep(1)
    #spin(19, 20, 0, 0.15) #flush
    #sleep(1)
    ...
    while loop:
        ...
        if(updated[0] < updated[2]):
            spin(19, 20, 0, 0.15)
            counter1 += 1
            print(str(counte1) + ": " + str(updated))
            sleep(5)
        elif(updated[0] < updated[2] && updated[2] == 255):
            spin(19, 20, 0, 0.15)
            counter1 += 1
            print(str(counter1) + ": " + str(updated))
            sleep(5)
        elif(updated[0] < updated[2] && updated[2] < 255)):
            small_spin(26, 20, 0, 0.009)
            counter2 += 1
            print(str(counter1 + counter2) + ": " + str(updated))
